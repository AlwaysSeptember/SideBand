...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
"undefined"!=typeof window&&window.__PREACT_DEVTOOLS__&&window.__PREACT_DEVTOOLS__.attachPreact("10.4.6",preact__WEBPACK_IMPORTED_MODULE_0__["options"],{Fragment:preact__WEBPACK_IMPORTED_MODULE_0__["Fragment"],Component:preact__WEBPACK_IMPORTED_MODULE_0__["Component"]});
...
/*!****************************!*\
  !*** ./tsx/CommsPanel.tsx ***!
  \****************************/
/*! exports provided: CommsPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommsPanel", function() { return CommsPanel; });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var danack_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! danack-message */ "./node_modules/danack-message/src/index.ts");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events */ "./tsx/events.tsx");




class CommsPanel extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.connect();
        Object(danack_message__WEBPACK_IMPORTED_MODULE_1__["registerMessageListener"])(_events__WEBPACK_IMPORTED_MODULE_2__["EventType"].trigger_sound, "CommsPanel_1", (data) => this.sendSound(data));
    }
    componentWillUnmount() {
        Object(danack_message__WEBPACK_IMPORTED_MODULE_1__["unregisterListener"])(_events__WEBPACK_IMPORTED_MODULE_2__["EventType"].trigger_sound, "CommsPanel_1");
    }
    sendSound(data) {
    ...
    onMessage(messageEvent) {
        ...
        Object(danack_message__WEBPACK_IMPORTED_MODULE_1__["sendMessage"])(_events__WEBPACK_IMPORTED_MODULE_2__["EventType"].received_sound, sound_data);
    }
    onClose(e) {
...
/***/ "./tsx/PeopleListPanel.tsx":
/*!*********************************!*\
  !*** ./tsx/PeopleListPanel.tsx ***!
  \*********************************/
/*! exports provided: PeopleListPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeopleListPanel", function() { return PeopleListPanel; });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events */ "./tsx/events.tsx");
/* harmony import */ var danack_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! danack-message */ "./node_modules/danack-message/src/index.ts");



function is_over_seconds_ago(date, seconds) {
    const previous_time = Date.now() - (1000 * seconds);
    return date < previous_time;
}
class PeopleListPanel extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        Object(danack_message__WEBPACK_IMPORTED_MODULE_2__["registerMessageListener"])(_events__WEBPACK_IMPORTED_MODULE_1__["EventType"].received_sound, "PeopleListPanel_1", (data) => this.listPerson(data));
        this.listClearing = setInterval(() => this.clearList(), 1000);
    }
    componentWillUnmount() {
        Object(danack_message__WEBPACK_IMPORTED_MODULE_2__["unregisterListener"])(_events__WEBPACK_IMPORTED_MODULE_1__["EventType"].trigger_sound, "PeopleListPanel_1");
    ...
    ;
    render(props, state) {
        let soundEventsBlah = this.state.soundEvents.map((item, key) => Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { key: key },
            item.type,
            " : ",
            item.username));
        return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null,
            Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", null, "Click list"),
            soundEventsBlah);
    }
}
...
/***/ "./tsx/SideBandPanel.tsx":
/*!*******************************!*\
  !*** ./tsx/SideBandPanel.tsx ***!
  \*******************************/
/*! exports provided: SideBandPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SideBandPanel", function() { return SideBandPanel; });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _SoundButtonPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SoundButtonPanel */ "./tsx/SoundButtonPanel.tsx");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events */ "./tsx/events.tsx");
...
/* harmony import */ var _CommsPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CommsPanel */ "./tsx/CommsPanel.tsx");
...
class SideBandPanel extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    componentDidMount() {
        Object(danack_message__WEBPACK_IMPORTED_MODULE_3__["registerMessageListener"])(_events__WEBPACK_IMPORTED_MODULE_2__["EventType"].received_sound, "SideBandPanel_1", (data) => this.playSound(data));
    }
    componentWillUnmount() {
        Object(danack_message__WEBPACK_IMPORTED_MODULE_3__["unregisterListener"])(_events__WEBPACK_IMPORTED_MODULE_2__["EventType"].trigger_sound, "SideBandPanel_1");
    }
    ;
    playSound(data) {
        let filenames = {
    ...
    render(props, state) {
        if (this.state.username === null) {
            return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null,
                Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, "Who are you?"),
                Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null,
                    Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { type: "text", value: this.state.usernameInput, onChange: (event) => this.handleChange((event)) }),
        ...
        return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'motions_panel_react' },
            ...
            Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])(_SoundButtonPanel__WEBPACK_IMPORTED_MODULE_1__["SoundButtonPanel"], { text: "Meow?", type: "meow" }),
            Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])(_SoundButtonPanel__WEBPACK_IMPORTED_MODULE_1__["SoundButtonPanel"], { text: "Question", type: "question" }),
            Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])(_SoundButtonPanel__WEBPACK_IMPORTED_MODULE_1__["SoundButtonPanel"], { text: "Dun dun dun", type: "boop" }));
    }
}
...
/***/ "./tsx/SoundButtonPanel.tsx":
/*!**********************************!*\
  !*** ./tsx/SoundButtonPanel.tsx ***!
  \**********************************/
/*! exports provided: SoundButtonPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SoundButtonPanel", function() { return SoundButtonPanel; });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events */ "./tsx/events.tsx");
/* harmony import */ var danack_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! danack-message */ "./node_modules/danack-message/src/index.ts");
...
function clickWasPressed(type) {
    Object(danack_message__WEBPACK_IMPORTED_MODULE_2__["sendMessage"])(_events__WEBPACK_IMPORTED_MODULE_1__["EventType"].trigger_sound, { type: type });
}
function SoundButtonPanel(props) {
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { onClick: () => clickWasPressed(props.type) }, props.text);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _SideBandPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SideBandPanel */ "./tsx/SideBandPanel.tsx");
/* harmony import */ var _PeopleListPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PeopleListPanel */ "./tsx/PeopleListPanel.tsx");
...
let panels = [
    {
        ...
        component: _SideBandPanel__WEBPACK_IMPORTED_MODULE_1__["SideBandPanel"]
    },
    {
        class: 'people_list_panel',
        component: _PeopleListPanel__WEBPACK_IMPORTED_MODULE_2__["PeopleListPanel"]
    },
];
...
var EventType;
(function (EventType) {
    EventType["send_sound"] = "send_sound";
    EventType["received_sound"] = "received_sound";
    EventType["trigger_sound"] = "trigger_sound";
})(EventType || (EventType = {}));
...
/***/ 0:
/*!*********************************!*\
  !*** multi ./tsx/bootstrap.tsx ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./tsx/bootstrap.tsx */"./tsx/bootstrap.tsx");
